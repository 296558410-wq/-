...
- freeze清单: research/V2_G3_DATA_FREEZE_20260917.md

## 新 Shadow run
- run_id: `V2-SHADOW-20260917-105319-b5e4`
- 开始: 2026-09-17T10:53:19.307152+00:00
- 结束: 2026-09-19T10:53:19.307152+00:00
- 已运行: 0.0 h (不足 24h)
- cycle 数: 1
- 决策: TRADE 0 / WAIT 1 / REJECT 0
- 执行: attempts 0 / executed 0 / rejected 0
- duplicate_skips: 0
...
## 证据链
- Replay MATCH: 1/1
- Ledger hash chain: PASS {"n": 3, "head": "e69189a4cd648bb172e9469184049c808b50bd88ed5ff7a9a0d28383c608ffc0"}
- Scheduler 漏周期: 0
- Agent1 失败: 0 · Agent2 失败: 0 · Hermes 失败: 0 · Ledger 失败: 0
- input_snapshot: 每 cycle 1/1
- Router provenance: per-cycle pit_cache source/source_hash (见 timeline + inputs/)

## 安全不变量
- execution_mode: PAPER(shadow/no-broker) (PAPER=不连 broker 下单路径)
- BROKER_ORDER_SENT: FALSE
- FORWARD_VALIDATION_ALLOWED: NO (保持 NO)
